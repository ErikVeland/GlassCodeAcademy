...
/**
 * Script to expand quiz pools to 40 questions per module with proper difficulty distribution
 */

const fs = require('fs');
const path = require('path');

// Performance Optimization quiz questions
const performanceOptimizationQuestions = [
  // Beginner questions (12 questions)
  {
    ...
    tags: ["Core Web Vitals", "beginner", "performance"],
  ...
  },
  {
    ...
    tags: ["Resource Loading", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
    ...
    tags: ["Code Splitting", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
    ...
    tags: ["Script Loading", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
    ...
    tags: ["Image Optimization", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
  ...
  },
  {
    ...
    tags: ["Caching", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
    ...
    tags: ["Infrastructure", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
  ...
  },
  {
    ...
    tags: ["Build Optimization", "beginner", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 45
  },
  {
  ...
  // Intermediate questions (20 questions)
  {
    ...
    tags: ["Caching", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
    ...
    tags: ["Build Optimization", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
    ...
    tags: ["Runtime Optimization", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
  ...
  },
  {
    ...
    tags: ["Rendering", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
  ...
  },
  {
    ...
    tags: ["Profiling", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
    ...
    tags: ["Networking", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
    ...
    tags: ["Resource Loading", "intermediate", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 60
  },
  {
  ...
  // Advanced questions (8 questions)
  {
    ...
    tags: ["Profiling", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  },
  {
    ...
    tags: ["Rendering", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  },
  {
    ...
    tags: ["Runtime Optimization", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  },
  {
    ...
    tags: ["Core Web Vitals", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  },
  {
  ...
  },
  {
    ...
    tags: ["Resource Loading", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  },
  {
  ...
  },
  {
    ...
    tags: ["Infrastructure", "advanced", "performance"],
    questionType: "multiple-choice",
    estimatedTime: 90
  }
];
...
quizFiles.forEach(file => {
  ...
  try {
    ...
    // Check if this is the performance-optimization quiz
    if (quiz.moduleSlug === 'performance-optimization') {
      console.log('  Expanding performance-optimization quiz...');
      
      // Add the new questions
      quiz.questions = quiz.questions.concat(performanceOptimizationQuestions);
      ...
      console.log('  ✓ Updated ' + file + ' with ' + quiz.questions.length + ' questions');
    } else {
...
console.log('Quiz pool expansion complete!');