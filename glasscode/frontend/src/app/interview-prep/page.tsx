  ...
  return (
    <div className={`module-card-container ${isLocked ? "locked" : ""}`}>
      ...
      >
        ...
        {isLocked && (
          ...
          >
            <div className="text-center">
              ...
              <p className="mt-2 text-primary-fg text-sm">
        ...
        {/* Icon and header */}
        <div
          className={`glass-morphism ${iconTierClass} rounded-t-xl p-4 flex items-center gap-3`}
        >
          <div className="text-3xl md:text-4xl leading-none" aria-hidden="true">
            {module.icon}
          </div>
          <div className="min-w-0">
            <h3 className="text-lg font-semibold text-fg truncate leading-tight">
              {module.title}
            </h3>
            <p className="text-muted text-sm truncate leading-tight">
              {categoryLabel}
            </p>
          </div>
        </div>
            ...
            <div className="mt-3 text-left space-y-1">
              ...
              <div className="flex flex-wrap gap-2">
                {module.prerequisites.map((p) => (
                  <span key={p} className="unlock-chip">
                    {p}
                  </span>
                ))}
              </div>
  ...
  return (
    ...
    >
      <div className={`tier-container bg-gradient-to-r ${tier.color}`}>
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 auto-rows-fr"
          role="list"
...
const InterviewPrepPage: React.FC = () => {
  ...
  const [moduleLockEnabled, setModuleLockEnabled] =
  ...
  const filteredTiers = Object.entries(interviewTiers).reduce(
    (acc, [tierKey, tier]) => {
      ...
      <main className="homepage w-full">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div className="hero-content">
                  ...
                  <p className="text-muted mb-6 text-left">
                    Prepare systematically for technical interviews through our
                    tier-based approach. From foundational concepts to
                    expert-level system design, build confidence with
        ...
        <section className="w-full py-8">
          <div className="bg-surface-alt backdrop-blur-sm rounded-xl shadow-lg border border-border">
            <div className="p-6">
              <h2 className="text-2xl font-bold text-center text-fg mb-6">
                Quick Actions
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-muted">
                    Return to main learning curriculum and lessons
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-muted">
                    Practice with interactive GraphQL queries
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-muted">
                    Explore our UI components and animations
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-muted">
                    Download progress, streaks, and achievements
                  </p>
                </button>
              </div>
            </div>
