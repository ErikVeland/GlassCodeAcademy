...
export default function WebLessonsPage() {
    ...
    const { data, loading, error, refetch } = useQuery(WEB_LESSONS_QUERY);
    ...
    const lessons: WebLesson[] = data?.webLessons ?? [];
    ...
    let currentLesson: WebLesson | null = null;
    let currentTopicLessons: WebLesson[] = [];
        ...
        return (
            <main className="p-6">
                <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div className="text-red-600 dark:text-red-400">Error loading Web Development lessons.</div>
                    <button 
    ...
    return (
        ...
        <div className="w-full p-6">
            ...
            <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <h1 className="text-3xl font-bold mb-6 mt-2 text-blue-700 dark:text-blue-300">Learn Web Development Basics Step by Step</h1>
                            ...
                            <>
                                {isLastCategory ? (
                                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                        ...
                                        <Link 
 href="/modules/web-fundamentals/quiz"
