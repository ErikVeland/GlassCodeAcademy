...
const PROGRAMMING_LESSONS_QUERY = gql`
  query ProgrammingLessons {
    programmingLessons {
      id
      topic
      title
...
export default function ProgrammingLessonsPage() {
    ...
    if (process.env.NEXT_PHASE === 'phase-production-build') {
        ...
        const minimalLessons: ProgrammingLesson[] = [
            ...
            { id: 2, topic: 'control', title: 'Control Structures', description: 'Learn about control structures', codeExample: 'if (x > 0) {\n  console.log("Positive");\n} else {\n  console.log("Negative or zero");\n}', output: 'Conditional execution' },
    ...
    if (error && !isNetworkError(error)) {
        return (
            <main className="p-6">
                <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div className="text-red-600 dark:text-red-400">Error loading Programming lessons.</div>
                    <button 
