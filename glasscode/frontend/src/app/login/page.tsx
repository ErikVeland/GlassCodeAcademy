  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 -left-32 h-80 w-80 rounded-full blur-3xl opacity-30 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500" />
        <div className="absolute -bottom-32 -right-40 h-96 w-96 rounded-full blur-3xl opacity-25 bg-gradient-to-br from-cyan-400 via-sky-500 to-indigo-500" />
      </div>

      <div className="relative z-10 mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10">
        {/* Brand / Hero panel */}
                  ...
                  return (
                    ...
                    >
                      <span className="btn-ico" aria-hidden="true">
                        {id === "google" && (
                          <img src="/brand/google_g_logo.svg" width="18" height="18" alt="" />
                        )}
                        {id === "apple" && (
