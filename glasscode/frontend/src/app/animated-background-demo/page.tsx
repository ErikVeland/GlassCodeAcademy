...
export default function AnimatedBackgroundDemo() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <a
        href="#main-content"
        className="sr-only focus:absolute focus:p-4 focus:bg-surface focus:text-primary focus:ring-2 ring-focus ring-offset-2 ring-offset-bg z-50"
      >
                ...
                <div className="relative p-6">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-muted max-w-2xl mx-auto">
                      This demo showcases a reusable animated background
                      component that can be customized with different colors,
                        ...
                        >
                          <div className="text-center">
                            ...
                            <div className="text-sm text-muted">
                              Create custom gradients with precise color control
                            </div>
                          </div>
                        </button>
                      </div>
                          ...
                          {presetColors.map((preset, index) => (
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{
                                  background: `linear-gradient(135deg, ${preset.colors
                                    .map((color) => {
                                      const [r, g, b, a] =
                                        color.match(/\d+\.?\d*/g) || [];
                                      return `rgba(${r}, ${g}, ${b}, ${a || 1})`;
                          ...
                          >
                            {isPaused ? (
                              <svg
                                ...
                                className="h-5 w-5 text-primary-fg"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                              >
                              ...
                              <div className="text-center">
                                <div className="inline-block p-3 rounded-full bg-surface-alt backdrop-blur-sm mb-2 border border-border">
                                  {previewIsPaused ? (
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      className="h-8 w-8 text-primary-fg"
                                      fill="currentColor"
                                      viewBox="0 0 24 24"
                                    >
                                      <path d="M8 5v14l11-7z" />
...
/>`}
                  ...
                  <div className="mt-8 text-center">
                    <p className="text-muted">
                      This animated background component can be used on any page
                      to create a sophisticated, customizable background effect
                      that enhances the visual appeal of your application.
                    </p>
                  </div>
                  ...
                  <div className="mt-12 flex justify-center items-center gap-4 flex-wrap">
                    ...
                    <a
                      ...
                      className="group relative overflow-hidden bg-[hsl(var(--primary)/0.1)] backdrop-blur-sm text-primary font-medium py-2 px-4 rounded-lg border border-border hover:bg-[hsl(var(--primary)/0.15)] transition-all duration-200 flex items-center gap-2 text-sm shadow-lg hover:shadow-xl"
                    >
                      <span className="text-base transition-transform group-hover:translate-y-1">
                        ⬇
                      </span>
