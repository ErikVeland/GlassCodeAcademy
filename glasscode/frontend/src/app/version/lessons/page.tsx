...
const VERSION_LESSONS_QUERY = gql`
  query VersionLessons {
    versionLessons {
      id
      topic
      title
...
export default function VersionLessonsPage() {
    ...
    const { data, loading, error, refetch } = useQuery(VERSION_LESSONS_QUERY);
    ...
    const lessons: VersionLesson[] = data?.versionLessons ?? [];
    ...
    let currentLesson: VersionLesson | null = null;
    let currentTopicLessons: VersionLesson[] = [];
        ...
        return (
            <main className="p-6">
                <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div className="text-red-600 dark:text-red-400">Error loading Version Control lessons.</div>
                    <button 
    ...
    return (
        ...
        <div className="w-full p-6">
            ...
            <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <h1 className="text-3xl font-bold mb-6 mt-2 text-blue-700 dark:text-blue-300">Learn Version Control with Git Step by Step</h1>
