...
export default function DotNetInterviewPage() {
  ...
  const { data, loading: gqlLoading, error: gqlError, refetch } = useQuery(DOTNET_INTERVIEW_QUESTIONS_QUERY);
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center">
            ...
            <div className="mb-6">
        <CircularProgress percent={Math.round((score / shuffledQuestions.length) * 100)} color="#8b5cf6" trackColor="#e5e7eb" />
