...
type TopicGroup = {
    topic: string;
    lessons: DotNetLesson[];
};

const DOTNET_LESSONS_QUERY = gql`
  query DotNetLessons {
    dotNetLessons {
      id
      topic
...
export default function DotNetLessonsPage() {
    ...
    const { data, loading, error, refetch } = useQuery(DOTNET_LESSONS_QUERY, {
        onError: (error) => {
    ...
    const lessons: DotNetLesson[] = data?.dotNetLessons ?? [];
    ...
    let currentLesson: DotNetLesson | null = null;
    let currentTopicLessons: DotNetLesson[] = [];
        ...
        return (
            <main className="p-6">
                <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div className="text-red-600 dark:text-red-400">Error loading .NET lessons.</div>
                    <button 
    ...
    return (
        ...
        <div className="w-full p-6">
            ...
            <div className="max-w-4xl mx-auto bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <h1 className="text-3xl font-bold mb-6 mt-2 text-blue-700 dark:text-blue-300">Learn .NET Core Fundamentals Step by Step</h1>
                ...
                {selectedTopic === null && (
                    <div>
                        ...
                        <TechnologyUtilizationBox 
                            technology=".NET" 
                            explanation="In this .NET module, .NET Core, C#, ASP.NET Core, Entity Framework, and enterprise patterns are taught using practical examples." 
                        />
                    </div>
                )}
                ...
                {selectedTopic !== null && currentLesson && (
                    ...
                    <div className="bg-gray-100/80 dark:bg-gray-700/80 backdrop-blur-sm p-6 rounded-xl shadow-lg space-y-4 mt-4 border border-gray-200 dark:border-gray-600">
                        ...
                        <div>
                            <h3 className="font-semibold mt-4 text-blue-700 dark:text-blue-300">C# Example:</h3>
