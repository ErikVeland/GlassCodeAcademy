...
export default function EditLessonPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Removed redundant effect calling fetchData without id
  // Removed redundant effect that previously called fetchData() without an id
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder='{"intro": "...", "objectives": [...], "code": "...", ...}'
                />
                <p className="mt-1 text-sm text-gray-500">
                  JSON format for lesson content. Be careful when editing.
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  id="metadata"
                  rows={6}
                  value={lesson.metadata}
                  onChange={handleMetadataChange}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm font-mono text-xs"
                  placeholder='{"tags": [...], "topic": "...", "description": "...", ...}'
                />
                <p className="mt-1 text-sm text-gray-500">
                  JSON format for lesson metadata. Be careful when editing.
                </p>
              </div>
