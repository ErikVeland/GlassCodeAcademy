    ...
    `}>
      ...
      <div className="relative h-full z-10">
        <div className="absolute bottom-4 left-4">
          {/* Main Stat */}
          <div className="mb-1">
            <div className="text-3xl font-bold text-white dark:text-gray-100 flex items-baseline 
          ...
          {/* Title */}
          <h3 className="text-sm font-medium text-white/90 dark:text-gray-200/90 mb-0.5 
          ...
          {/* Description */}
          {description && (
            <p className="text-xs text-white/70 dark:text-gray-300/70 drop-shadow 
