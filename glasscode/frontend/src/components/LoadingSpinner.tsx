  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-xl shadow-lg border border-white/50 dark:border-gray-700/50">
      <div className="mb-6 flex justify-center">
        ...
        <div className="relative" style={{ height: size === 'sm' ? 32 : size === 'md' ? 64 : 96, width: size === 'sm' ? 32 : size === 'md' ? 64 : 96 }}>
          <svg
      ...
      <p className="text-gray-600 dark:text-gray-400 text-center max-w-md">
        We&apos;re preparing your personalized learning experience. This may take a moment.
      </p>
