...
const ColorSchemeEditor: React.FC<ColorSchemeEditorProps> = ({
  ...
  const updateColors = useCallback((stops: ColorStop[]) => {
  ...
  const updateStopColor = useCallback((stopId: string, newColor: string) => {
  ...
  const updateStopPosition = useCallback((stopId: string, newPosition: number) => {
            ...
            >
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  max="100"
                  value={stop.position}
                  onChange={(e) => updateStopPosition(stop.id, parseFloat(e.target.value))}
