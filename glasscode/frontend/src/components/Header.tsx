                ...
                <div className="origin-top-right absolute right-0 mt-2 w-64 rounded-xl shadow-lg bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700 z-[9999]">
                  <div className="py-2 px-4" role="menu">
                    ...
                    <div className="space-y-2">
                      ...
                      <Link href="/forum" className="block px-3 py-2 text-sm font-medium text-muted hover:bg-surface-alt hover:text-primary rounded transition-colors duration-150" role="menuitem" onClick={closeTierDropdowns}><span className="mr-2">💬</span> Forum</Link>
