...
export default function MobileMenu() {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Mobile menu panel */}
      <div className={`${isOpen ? 'block' : 'hidden'} absolute top-16 left-0 right-0 z-[1000] bg-surface/90 backdrop-blur-sm shadow-lg border-t border-border`}>
        <div className="pt-2 pb-3 space-y-1">
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider">.NET</div>
          <Link
            href="/lessons"
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">Next.js</div>
          <Link
            href="/nextjs/lessons"
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">GraphQL</div>
          <Link
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">Laravel</div>
          <Link
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">React</div>
          <Link
            href="/react/lessons"
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">Tailwind CSS</div>
          <Link
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">Node.js</div>
          <Link
            href="/node/lessons"
          ...
          <div className="px-4 py-2 text-xs font-semibold text-muted uppercase tracking-wider mt-4">SASS</div>
          <Link
            href="/sass/lessons"
