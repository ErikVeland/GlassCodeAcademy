...
// Module routes
router.post('/courses/:courseId/modules', generalLimiter, createModuleController);
router.get('/courses/:courseId/modules', generalLimiter, getModulesByCourseIdController);
...
// Lesson routes
router.post('/modules/:moduleId/lessons', generalLimiter, createLessonController);
router.get('/modules/:moduleId/lessons', generalLimiter, getLessonsByModuleIdController);
...
router.get('/lessons/:lessonId/quizzes', generalLimiter, getQuizzesByLessonIdController);
