...
(async () => {
  try {
    const { setupTestDb, teardownTestDb, clearDatabase } = require('../src/__tests__/fixtures/testDatabase');
    ...
    console.log('Health response:', res.status, res.body && res.body.data && res.body.data.message);
