...
export const ENHANCED_ACHIEVEMENTS: Record<string, ExtendedAchievement> = {
  ...
  "first-steps": {
    ...
    rarity: "common",
    points: 10,
    requirements: [{ type: "lesson_count", target: 1, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "getting-started": {
    ...
    rarity: "common",
    points: 25,
    requirements: [{ type: "lesson_count", target: 5, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  perfectionist: {
    ...
    rarity: "rare",
    points: 200,
    requirements: [{ type: "quiz_score", target: 100, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "quiz-master": {
    ...
    rarity: "epic",
    points: 350,
    requirements: [{ type: "quiz_score", target: 90, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "consistent-learner": {
    ...
    rarity: "common",
    points: 30,
    requirements: [{ type: "streak_days", target: 3, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "dedicated-student": {
    ...
    rarity: "uncommon",
    points: 75,
    requirements: [{ type: "streak_days", target: 7, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "streak-warrior": {
    ...
    rarity: "rare",
    points: 150,
    requirements: [{ type: "streak_days", target: 14, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  "streak-legend": {
    ...
    rarity: "epic",
    points: 300,
    requirements: [{ type: "streak_days", target: 30, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
  ...
  unstoppable: {
    ...
    rarity: "legendary",
    points: 1000,
    requirements: [{ type: "streak_days", target: 100, condition: "minimum" }],
    unlocked: false,
    progress: 0,
  },
...
export interface UserProgressSummary {
  ...
  tierProgress?: Partial<
    Record<"foundational" | "core" | "specialized" | "quality", number>
  >;
}
