...
export const APP_PHASES: Phase[] = [
  {
    ...
    description:
      "Establish the fundamental architecture and core learning platform",
    order: 1,
    status: "completed",
      ...
      },
      {
        ...
        milestones: [
          ...
          },
          {
            ...
            description:
              "Semantic color tokens, 3-way switch, no first-paint flash",
            completed: true,
            completedDate: "2025-10-30",
            weight: 0.2,
          },
  ...
  },
  {
    ...
    goals: [
      ...
      },
      {
        ...
        description:
          "Code playground, live examples, and interactive exercises",
        importance: 6,
        currentProgress: 100,
        previousProgress: 65,
        lastUpdated: "2025-10-30",
        ...
        milestones: [
          ...
          },
          {
            ...
            description:
              "Interactive playground with real-time controls, Photoshop-style color editor, live preview, and liquid glass design",
            completed: true,
      ...
      },
      {
        ...
        milestones: [
          ...
          },
          {
            ...
            description:
              "Document practices to prevent hot reload chunk errors",
            completed: true,
            completedDate: "2025-10-18",
            weight: 0.25,
          },
...
export function calculateGoalProgress(goal: Goal): number {
  const totalWeight = goal.milestones.reduce(
...
export function getRecentProgressIncreases(): Array<
  Goal & { progressIncrease: number }
> {
  return APP_PHASES.flatMap((phase) => phase.goals)
