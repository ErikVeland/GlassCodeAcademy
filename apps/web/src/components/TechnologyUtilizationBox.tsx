...
const TechnologyUtilizationBox = ({
  technology,
  explanation,
}: TechnologyUtilizationBoxProps) => {
  ...
  const getColorScheme = () => {
    switch (technology.toLowerCase()) {
      ...
      case ".net":
        return "bg-purple-50 dark:bg-purple-900/30 border-purple-200 dark:border-purple-700 text-purple-800 dark:text-purple-200";
      default:
  ...
  return (
    <div
      className={`mt-6 p-4 ${getColorScheme()} rounded-lg backdrop-blur-sm border`}
    >
