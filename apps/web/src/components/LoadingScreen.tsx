    ...
    >
      <div className="glass-morphism w-full max-w-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-md px-6 py-5">
        <div className="flex items-center gap-4">
          <svg
            className={`animate-spin ${sizeClass} text-blue-600 dark:text-blue-500`}
            viewBox="0 0 24 24"
            role="img"
            aria-hidden="true"
          >
                ...
                <div className="mt-2 w-full">
                  <div className="bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, Math.round((prefetchStatus.prefetchedCount / Math.max(1, prefetchStatus.prefetchedCount + prefetchStatus.queueLength)) * 100))}%`,
                      }}
                    ></div>
                  </div>
